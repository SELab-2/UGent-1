...
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql" if postgres else "django.db.backends.sqlite3",
        "NAME": "pigeonhole" if postgres else BASE_DIR / "db.sqlite3",
        "USER": "postgres" if postgres else "user",
        "PASSWORD": "password",
        "HOST": "localhost",
        "PORT": "5432",
    }
